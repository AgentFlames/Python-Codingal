...
FONT_SIZE = 72
pygame.init()
background_image = pygame.transform.scale(pygame.image.load("/Users/pirteeklakhani/Desktop/Yuvraj/Python/Python Codingal/lesson 34/City_of_Tears_Fountain_Square.webp"), 
